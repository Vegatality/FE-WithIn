  ...
  return (
    <div className="w-full">
      <div className=" flex flex-row justify-between items-center">
        <div className="flex flex-row justify-center items-center h-11 my-5 w-40 rounded-md bg-mainPurple text-white">{name}</div>
        {role === "ADMIN" ? (
      ...
      <div className="flex flex-row items-center p-4 w-full h-fit bg-sectionPurple shadow-sm rounded-md">
        ...
        <div className="w-full">
          <div className=" grid grid-cols-2 lg:grid-cols-3 gap-2   p-2  auto-cols-max auto-rows-max h-full">{children}</div>
        </div>
        <div>
